...
public class TestMenuFact02 {
    ...
    public static void main(String[] args) {
        ...
        PlatAuMenu p1 = new PlatAuMenu(0,"PlatAuMenu0",10, null);
        PlatAuMenu p2 = new PlatAuMenu(1,"PlatAuMenu1",20, null);
        PlatAuMenu p3 = new PlatAuMenu(2,"PlatAuMenu2",30, null);
        PlatAuMenu p4 = new PlatAuMenu(3,"PlatAuMenu3",40, null);
        PlatAuMenu p5 = new PlatAuMenu(4,"PlatAuMenu4",50, null);


        PlatSante ps1 = new PlatSante(10,"PlatSante0",10,11,11,11, null);
        PlatSante ps2 = new PlatSante(11,"PlatSante1",20,11,11,11, null);
        PlatSante ps3 = new PlatSante(12,"PlatSante2",30,11,11,11, null);
        PlatSante ps4 = new PlatSante(13,"PlatSante3",40,11,11,11, null);
        PlatSante ps5 = new PlatSante(14,"PlatSante4",50,11,11,11, null);
